...
void GUI::PrintMessage(string msg) const	//Prints a message on status bar
{
	...
	//pWind->DrawString(10, WindHeight - (int) (StatusBarHeight/1.5), msg); // You may need to change these coordinates later 
																		  // to be able to write multi-line
	double i = 10.0; //this upcoming couple lines of code add up new lines to print messages in status bar
	string Line;
	istringstream ISS(msg);
	while (getline(ISS, Line))
	{
		pWind->DrawString(10, WindHeight - (int)(StatusBarHeight - i), Line);
		i += 17;
	}
}
//////////////////////////////////////////////////////////////////////////////////////////
...
void GUI::AddToDrawingList(const Enemy* pE)
{
	...
	//if (t == 0 && s==1)
	//{
	//	UpdateStatusBar(pE->GetDistance());
	//	waitForClick();
	//}
	...
	/////////////
	///////////////
	ENMY_STATUS enemy_status = pE->GetStatus();
	GUI_REGION reg;
